...
Публичный адрес файла — https://github.com/kma-art/PPG2ABP_Evaluation/blob/main/article_revision_extended_materials.md; ссылки на файлы пакета даны относительно корня того же репозитория.
...
Публичный пакет содержит следующие основные файлы (полный перечень — в README репозитория):
